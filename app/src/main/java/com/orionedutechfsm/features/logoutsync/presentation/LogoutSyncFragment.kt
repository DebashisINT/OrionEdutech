package com.orionedutechfsm.features.logoutsync.presentation
...
import com.orionedutechfsm.app.AppDatabase
...
import com.orionedutechfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.orionedutechfsm.features.addshop.api.AddShopRepositoryProvider
import com.orionedutechfsm.features.billing.api.AddBillingRepoProvider
import com.orionedutechfsm.features.billing.model.AddBillingInputParamsModel
...
import com.orionedutechfsm.features.dashboard.presentation.ReasonDialog
...
import com.orionedutechfsm.features.document.model.AddEditDocumentInputParams
import com.orionedutechfsm.features.document.model.DocumentAttachmentModel
...
import com.orionedutechfsm.features.location.model.*
...
import com.orionedutechfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.orionedutechfsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.orionedutechfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.orionedutechfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.orionedutechfsm.features.orderhistory.model.*
...
import com.orionedutechfsm.features.quotation.model.AddQuotInputModel
import com.orionedutechfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.orionedutechfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.orionedutechfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.orionedutechfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.orionedutechfsm.features.timesheet.model.AddTimeSheetInputModel
import com.orionedutechfsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.orionedutechfsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.orionedutechfsm.features.viewAllOrder.model.AddOrderInputProductList
import com.orionedutechfsm.mappackage.SendBrod
import com.orionedutechfsm.widgets.AppCustomTextView
import com.orionedutechfsm.MonitorService
import com.orionedutechfsm.features.addshop.model.*
import com.orionedutechfsm.features.addshop.model.assigntopplist.AddShopUploadImg
import com.orionedutechfsm.features.login.api.LoginRepositoryProvider
import com.orionedutechfsm.features.login.model.GetConcurrentUserResponse
import com.orionedutechfsm.features.returnsOrder.ReturnProductList
import com.orionedutechfsm.features.returnsOrder.ReturnRequest
import com.orionedutechfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xorionedutechfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xorionedutechfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xorionedutechfsmlogsample/log.zip").path);
